...
- `TSC desynchronization`: compares MPERF against MSR::TSC, RDTSC, and RDTSCP. It flags when these P0-derived TSC time does not advance consistently with the reference performance counter by more than 5%.
